...
const Skills = () => {
    return (
        ...
        <div className="ms-0 lg:ms-[130px] skillbg -mt-[21rem] lg:-mt-[330px] relative pt-[465px] pb-4"  >
           ...
           <div className="z-10 relative customContaier" id="skills">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-y-9 gap-x-4 mt-20 mb-24 text-white w-[93%] mx-auto">
                    <div className="text-center border-2 border-white space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#36b5ff] transition-all duration-300 bg-[rgba(0,0,0,.35)]" data-aos-duration="900" data-aos="fade-right">
                        <img className="w-16 mx-auto" src={html} alt="" />
                        <p className="text-lg font-semibold">HTML</p>
                        <p className="text-[#36b5ff] text-4xl">85%</p>
                    </div>
                    <div className="bg-[rgba(0,0,0,.35)] text-center border-2 space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#24a2eb] transition-all duration-300" data-aos-duration="1400" data-aos="fade-right">
                        <img className="w-16 mx-auto" src={css} alt="" />
                        <p className="text-lg font-semibold">CSS</p>
                        <p className="text-[#36b5ff] text-4xl">85%</p>
                    </div>
                    <div className="text-center bg-[rgba(0,0,0,.35)] border-2 space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#24a2eb] transition-all duration-300" data-aos-duration="1900" data-aos="fade-right">
                        <img className="w-16 mx-auto" src={js} alt="" />
                        <p className="text-lg font-semibold">JavaScript</p>
                        <p className="text-[#36b5ff] text-4xl">75%</p>
                    </div>
                    <div className="text-center bg-[rgba(0,0,0,.35)] border-2 space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#24a2eb] transition-all duration-300" data-aos-duration="2400" data-aos="fade-right">
                        <img className="w-16 mx-auto" src={react} alt="" />
                        <p className="text-lg font-semibold">React</p>
                        <p className="text-[#36b5ff] text-4xl">70%</p>
                    </div>
                    <div className="text-center bg-[rgba(0,0,0,.35)] border-2 space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#24a2eb] transition-all duration-300" data-aos-duration="900" data-aos="fade-right">
                        <img className="w-16 mx-auto" src={tailwind} alt="" />
                        <p className="text-lg font-semibold">Tailwind</p>
                        <p className="text-[#36b5ff] text-4xl">75%</p>
                    </div>
                    <div className="text-center bg-[rgba(0,0,0,.35)] border-2 space-y-3 py-10 rounded-full w-auto lg:w-[180px] h-[230px] hover:border-[#24a2eb] transition-all duration-300" data-aos-duration="1400" data-aos="fade-right">
