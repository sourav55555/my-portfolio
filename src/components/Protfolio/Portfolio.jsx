    ...
    return (
        <div className=" bg-[rgb(105,114,138)] lg:ms-[130px] p-6" id="portfolio">
            ...
            <div className="lg:w-[84%] mx-auto py-20">
                <p className="text-5xl font-bold font1 text-center text-white skill" data-aos="zoom-in-down" data-aos-duration="900"> <FontAwesomeIcon  className="text-[#6fcaff] icon md:mb-0 mb-6" icon={faNfcDirectional} /> Portfolio</p>
                ...
                {
                    loading ? <p className="py-12 w-fit mx-auto"><PushSpinner size={30} color="#003d60" loading={true} /></p> : (<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-20">
                    {
